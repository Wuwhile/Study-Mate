            ...
            articles: [
                {
                    ...
                    summary: "从学习画像、目标拆解、资源模板到质量评估，完整说明擎思启学如何生成个性化学习资料。",
                    content: `适用场景
...
AI 辅助建议
每天结束后，把“今天最不懂的一点”和“做错的一题”发给擎思启学，让资源智能体生成第二天的补充讲义和变式题。`,
                    category: "review",
                    author: "计划智能体",
                    authorTitle: "阶段学习规划",
...
AI 使用方式
把你的错题清单发给擎思启学，让它生成“最后 48 小时复习优先级”和 10 道压缩小测题。`,
                    category: "exam",
                    author: "评价智能体",
                    authorTitle: "复盘与提分建议",
